 ...
 * the Cartesian X/Y/Z/Rx/Ry/Rz grid in World/Tool frames), speed override, live
 * TCP pose + manipulability, "go to pose", and the safety controls. Each section
 * is its own presentational module; shared state lives in the pendant / machine /
 * robot stores.
 */
function Divider() {
...
export function Pendant() {
  ...
  const cartesian = frame === 'world' || frame === 'tool'
